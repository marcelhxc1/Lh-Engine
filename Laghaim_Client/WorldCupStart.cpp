...
void CWorldCupStart::LoadRes()
{
	...
	if( m_pSurTime )
		m_pSurTime->SetColorKey(RGB(255, 0, 255));
	if( m_pSurScoreBoard )
		m_pSurScoreBoard->SetColorKey(RGB(255, 0, 255));
	for( int i = 0; i < 10; i++ )
	{
		if( m_pSurScoreA[i] )
			m_pSurScoreA[i]->SetColorKey(RGB(255, 0, 255));
		if( m_pSurScoreB[i] )
			m_pSurScoreB[i]->SetColorKey(RGB(255, 0, 255));
		if( m_pSurScoreA10[i] )
			m_pSurScoreA10[i]->SetColorKey(RGB(255, 0, 255));
		if( m_pSurScoreB10[i] )
			m_pSurScoreB10[i]->SetColorKey(RGB(255, 0, 255));
	}
