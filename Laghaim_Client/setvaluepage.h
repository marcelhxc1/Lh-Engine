...
#define SETVAL_VITL_FCOLOR	RGB(246, 11, 61)
#define SETVAL_MANA_FCOLOR	RGB(123, 110, 244)
#define SETVAL_STAM_FCOLOR	RGB(49, 220, 85)
#define SETVAL_EPOW_FCOLOR	RGB(168, 196, 36)
