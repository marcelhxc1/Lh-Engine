...
//	 = pDis;
	...
	m_pAttNormal->SetColorKey(RGB(255, 0, 255));
	m_pAttDisable->SetColorKey(RGB(255, 0, 255));
	...
	m_pRotateNormal->SetColorKey(RGB(255, 0, 255));
	m_pRotateDisable->SetColorKey(RGB(255, 0, 255));
