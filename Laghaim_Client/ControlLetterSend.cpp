...
void ControlLetterSend::LoadRes()
{
	...
	m_tbTitle.Init(bgx + 84, bgy + 46, 36, RGB(0,0,0), RGB(255,255,255));
	m_tbTitle.SetfontSize();
	m_tbName.Init(bgx + 84, bgy + 121, 40, RGB(0,0,0), RGB(255,255,255));
	m_tbName.SetfontSize();

	m_pLetterBox = new CLetterBox();
	m_pLetterBox->Init_MEBox(false, 9, 34);
	m_pLetterBox->Init(0, 0, 30, RGB(0,0,0), RGB(255,255,255));
