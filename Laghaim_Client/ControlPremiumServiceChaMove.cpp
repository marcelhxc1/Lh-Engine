...
void CControlPremiumChaMove::LoadRes()
{
	...
	if( m_pSurfAgreeBg )
	{
		...
		m_pSurfAgreeBg->SetColorKey(RGB(255, 0, 255));
	}
	...
	if( m_pSurfWearingBg )
	{
		...
		m_pSurfWearingBg->SetColorKey(RGB(255, 0, 255));
	}
...
void CControlPremiumChaMove::SetChaInfo(char* nameFrom, char* nameTo, int level, int race)
{
	...
	g_pDisplay->CreateSurfaceFromText( &m_pSurfChaName, m_Font, temp, RGB(255, 0, 255), RGB(255,200,1000) );
	m_pSurfChaName->SetColorKey(RGB(255, 0, 255));

	sprintf(temp,G_STRING(IDS_LHSTRING1821), g_pNk2DFrame->GetWindowRes()->GetRaceName(m_Race));
	g_pDisplay->CreateSurfaceFromText( &m_pSurfChaRace, m_Font, temp, RGB(255, 0, 255), RGB(255,200,1000) );
	m_pSurfChaRace->SetColorKey(RGB(255, 0, 255));

	sprintf(temp,G_STRING(IDS_LHSTRING1822), m_Level);
	g_pDisplay->CreateSurfaceFromText( &m_pSurfChaLevel, m_Font, temp, RGB(255, 0, 255), RGB(255,200,1000) );
	m_pSurfChaLevel->SetColorKey(RGB(255, 0, 255));
