...
void CControlPetMacro::LoadRes()
{
	...
	if( m_pSurfaceBack )
	{
		...
		for( int i = 0 ; i < PET_MACRO_MAX ; ++i )
		{
			...
			m_ModeComboBox[i].InsertItem( " ",13, RGB(100,200,200), RGB(255,255,255) );
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MOOD_0),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MOOD_0 : 전투모드
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MOOD_1),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MOOD_1 : 동행모드
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MOOD_2),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MOOD_2 : 획득모드
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MOOD_3),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MOOD_3 : 회피모드
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MODE_4),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MODE_4 : 지원모드
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MODE_5),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MODE_5 : 해제모드
			m_ModeComboBox[i].InsertItem( (char *)G_STRING(IDS_LSHIFT_MODE_6),13, RGB(100,200,200), RGB(255,255,255) ); // IDS_LSHIFT_MODE_6 : 경계모드
