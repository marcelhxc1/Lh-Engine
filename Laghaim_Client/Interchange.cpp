...
static int InterChangeVnum [][4] =
{
	...
	{332,337,342,420},
	{350,355,360,425},
	{484,485,486,715},			// 에댜 신발
	{475,476,477,712},			// 에댜 헬멧
	{478,479,480,713},			// 에댜 갑옷.
	{481,482,483,714},			// 바지.
	{507,508,509,859},
	{498,499,500,856},
	{501,502,503,857},
	{504,505,506,858},
	{490,496,497,921},			// 29, 태극보관함 //0304

	{696,697,698,699},	// 백기사 헬멧
	{700,701,702,703},  // 백기사 갑옷.
	{704,705,706,707},	// 백기사 바지
	{708,709,710,711},	// 백기사 신발
	{624,625,626,877},	// 헬멧
	{628,629,630,878},	// 갑옷
	{631,632,633,879},  // 바지
	{634,635,636,880},	// 신발.
	...
	{1010,1010,1010,1010}, // 경품권...복권...
	{1031,1031,1031,1031},	// 발렌타인 교환권
	{1308,1308,1308,1308},	//mungmae-2005/10/5 이판사판 행운권
	{1468,1468,1468,1468},  //mungmae-2006/08/14 빨간 성물 상자
//===============================
// nate 2004 - 5
// CastleWar
	{ 956, 956, 956, 956 },
//===============================
	...
	// 플래티늄 방어구
	{984,985,986,987},	// 플래헬멧
	{988,989,990,991},	// 플래갑옷
	{992,993,994,995},  // 플래바지
	{996,997,998,999},	// 플래신발.
};
...
void CInterchange::ShowItemsToChange()
{
	...
	for (i=0; i < INTERCHANGE_NUM; i++)
	{
		...
		if ( pChangeItem->m_Vnum == InterChangeVnum[i][0])
		{
			...
			if (InterChangeVnum[i][0] != InterChangeVnum[i][3] && InterChangeVnum[i][1] != InterChangeVnum[i][3] && InterChangeVnum[i][2] != InterChangeVnum[i][3])
			{
				// make dummy items
				pItem = new CItem;
				if( !pItem )
...
/////////////////////
		...
		{
			bWillChange = ShowItemsToChange2(i, 1, 0, 2, 3);
			break;
		}
		else if ( pChangeItem->m_Vnum == InterChangeVnum[i][2])
		{
			bWillChange = ShowItemsToChange2(i, 2, 0, 1, 3);
			break;
		}
		else if ( pChangeItem->m_Vnum == InterChangeVnum[i][3])
		{
			bWillChange = ShowItemsToChange2(i, 3, 0, 1, 2);
			break;
		}
	}
...
// 동급의 갑옷으로 바꾸기 위한 루틴.
BOOL CInterchange::ShowItemsToChange2(int idx, int sel, int candi1, int candi2, int candi3)
{
