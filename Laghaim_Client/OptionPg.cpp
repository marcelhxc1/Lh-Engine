...
void COptionPg::LoadRes()
{
	...
	if( m_pEffVolume )		m_pEffVolume->SetColorKey(RGB(255, 0, 255));
	if( m_pMusicVolume )	m_pMusicVolume->SetColorKey(RGB(255, 0, 255));
	if( m_pDragVolume1 )	m_pDragVolume1->SetColorKey(RGB(255, 0, 255));
	if( m_pDragVolume2 )	m_pDragVolume2->SetColorKey(RGB(255, 0, 255));
	if( m_pDragVolume1_C )	m_pDragVolume1_C->SetColorKey(RGB(255, 0, 255));
	if( m_pDragVolume2_C )	m_pDragVolume2_C->SetColorKey(RGB(255, 0, 255));
