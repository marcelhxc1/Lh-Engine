...
void CControlScore::LoadRes_NEW()
{
	...
	m_face.SetPos(bgx + 28, bgy + 62);
	m_btn_close.SetPosition( bgx + 272 , bgy + 5 );
	m_btn_quest.SetPosition( bgx + 199 , bgy + 278 );
	m_btn_pet.SetPosition(bgx + 199, bgy + 308);
	...
	for(int i=0 ; i<LEVELBTN_CNT ; i++ )
	{
		m_btn_pointup[i].SetPosition( bgx + 171 , bgy + 232 + gap_y*i );
	}
	...
	m_textout[ScoreTextOut_Type__Name].Init(TextOut_Font__Size, text_color, bgx + 205, bgy + 57, 123, 17, TRUE);
	m_textout[ScoreTextOut_Type__Race].Init(TextOut_Font__Size, text_color, bgx + 205, bgy + 78, 123, 17, TRUE);
	m_textout[ScoreTextOut_Type__Level].Init(TextOut_Font__Size, text_color, bgx + 205, bgy + 99, 123, 17, TRUE);
	m_textout[ScoreTextOut_Type__Penalty].Init(TextOut_Font__Size, text_color, bgx + 205, bgy + 120, 123, 17, TRUE);

	m_textout[ScoreTextOut_Type__Vital].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 147, 176, 17, TRUE);
	m_textout[ScoreTextOut_Type__Mana].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 168, 176, 17, TRUE);
	m_textout[ScoreTextOut_Type__Stamina].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 189, 176, 17, TRUE);
	m_textout[ScoreTextOut_Type__EErg].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 210, 176, 17, TRUE);

	m_textout[ScoreTextOut_Type__Strength].Init(TextOut_Font__Size, text_color, bgx + 129, bgy + 237, 77, 17, TRUE);
	m_textout[ScoreTextOut_Type__Wisdom].Init(TextOut_Font__Size, text_color, bgx + 129, bgy + 258, 77, 17, TRUE);
	m_textout[ScoreTextOut_Type__Dex].Init(TextOut_Font__Size, text_color, bgx + 129, bgy + 279, 77, 17, TRUE);
	m_textout[ScoreTextOut_Type__Strain].Init(TextOut_Font__Size, text_color, bgx + 129, bgy + 300, 77, 17, TRUE);
	m_textout[ScoreTextOut_Type__Charisma].Init(TextOut_Font__Size, text_color, bgx + 129, bgy + 321, 77, 17, TRUE);

	m_textout[ScoreTextOut_Type__LevelUpPoint].Init(TextOut_Font__Size, text_color, bgx + 234, bgy + 258, 65, 17, TRUE);

	m_textout[ScoreTextOut_Type__Def].Init(TextOut_Font__Size, text_color, bgx + 146, bgy + 348, 112, 17, TRUE);

	m_textout[ScoreTextOut_Type__TotalExp].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 438, 176, 17, TRUE);
	m_textout[ScoreTextOut_Type__ExpLevel].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 459, 176, 17, TRUE);

	m_textout[ScoreTextOut_Type__BP].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 486, 176, 17, TRUE);
	m_textout[ScoreTextOut_Type__Fame].Init(TextOut_Font__Size, text_color, bgx + 178, bgy + 507, 176, 17, TRUE);
}
