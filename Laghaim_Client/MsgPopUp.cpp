...
void CMsgPopUp::LoadRes()
{
	...
	case TYPE_EXCHANGE_EX:	// 금괴가 추가된 가격입력용. ///개인상점
		...
		m_InputLine.SetMaxLen(16);
		m_InputLine.SetfontSize( 12);
		m_InputLine.SetPos(m_pBack->Xpos+61, m_pBack->Ypos+105);
		...
		m_InputValue1.SetPos(m_pBack->Xpos+50, m_pBack->Ypos+67);
		...
		m_InputValue2.SetPos(m_pBack->Xpos+103, m_pBack->Ypos+67);
		...
		m_InputValue3.SetPos(m_pBack->Xpos+156, m_pBack->Ypos+67);
