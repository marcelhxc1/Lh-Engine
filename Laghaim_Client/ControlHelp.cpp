...
void CControlHelp::LoadRes()
{
	...
	m_tab_01.SetPosition( bgx + 17 , bgy + 68 );
	m_tab_02.SetPosition( bgx + 96 , bgy + 68 );

	m_btn_list.SetPosition( bgx + 131 , bgy + 378 );
	m_btn_prev.SetPosition( bgx + 97 , bgy + 378 );
	m_btn_next.SetPosition( bgx + 164 , bgy + 378 );
	...
	for( i=0 ; i<SYNTEX_ALL_NUM ; i++ )
	{
		m_btn_link[i].SetPosition( bgx + 16+10 , bgy + 93 + 10 + gap_h * (i%10) );
		m_help[i].SetPos( bgx + 16 + 10 , bgy + 93 + 10 );
	}
	...
	if( g_dwClientCountry == CTRY_KOR ) // 한국만...
		m_LinkKrServiceLv.SetPosition(bgx + 16+10 , bgy + 93 + 10 + gap_h * 9);
}
